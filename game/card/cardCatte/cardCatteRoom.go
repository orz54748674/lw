...
type Room struct {
	...
	RoomRobotConf       []cardCatteStorage.RobotConf
...
func (self *Room) OnInit(app module.App, settings *conf.ModuleSettings) {
	...
	self.GetServer().RegisterGO("/cardCatte/onDisconnect", self.onDisconnect)
	common.AddListener(self.GetServerID(), common.EventDisconnect, "/cardCatte/onDisconnect")
