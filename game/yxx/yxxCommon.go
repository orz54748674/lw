...
const ResultsRecordNum = 30 //最近多少条开奖记录
const ResultsPoolNum = 50   //最近多少条大奖记录
const InitPrizeCnt = 10000  //奖池期数的初始值
//
////-----------------机器人---
...
type PlayerList struct {
	...
	XiaZhuResult      map[yxxStorage.XiaZhuResult][]int64 `bson:"XiaZhuResult" json:"XiaZhuResult"`           //单注下注结果
	XiaZhuResultTotal map[yxxStorage.XiaZhuResult]int64   `bson:"XiaZhuResultTotal" json:"XiaZhuResultTotal"` //下注总结果
	LastXiaZhuResult  map[yxxStorage.XiaZhuResult][]int64 `bson:"LastXiaZhuResult" json:"LastXiaZhuResult"`   //上次下注结果
...
func (this *MyTable) GetTableInfo(countDown bool) interface{} {
	...
	type Info struct {
		...
		Results       JiesuanData
		XiaZhuTotal   map[yxxStorage.XiaZhuResult]int64
		XiaZhuTime    int
		JieSuanTime   int
		ReadyGameTime int
		CurInPool     int64
